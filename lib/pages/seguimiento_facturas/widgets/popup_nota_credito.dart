...
class FolioNotaCreditoPopup extends StatefulWidget {
  const FolioNotaCreditoPopup({
    Key? key,
  ...
  @override
  State<FolioNotaCreditoPopup> createState() => _FolioNotaCreditoPopupState();
}

class _FolioNotaCreditoPopupState extends State<FolioNotaCreditoPopup> {
